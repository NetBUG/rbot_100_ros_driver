...
"""autogenerated by genpy from rbot_100_driver/Diagnostic.msg. Do not edit."""
import sys
...
class Diagnostic(genpy.Message):
  ...
  _type = "rbot_100_driver/Diagnostic"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_4h4B2hb().pack(_x.left_motor_current, _x.right_motor_current, _x.main_brush_current, _x.side_brush_current, _x.left_motor_overcurrent, _x.right_motor_overcurrent, _x.main_brush_overcurrent, _x.side_brush_overcurrent, _x.battery_current, _x.battery_voltage, _x.battery_temperature))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.left_motor_current, _x.right_motor_current, _x.main_brush_current, _x.side_brush_current, _x.left_motor_overcurrent, _x.right_motor_overcurrent, _x.main_brush_overcurrent, _x.side_brush_overcurrent, _x.battery_current, _x.battery_voltage, _x.battery_temperature,) = _get_struct_4h4B2hb().unpack(str[start:end])
...
def _get_struct_I():
    global _struct_I
    return _struct_I
_struct_4h4B2hb = None
def _get_struct_4h4B2hb():
    global _struct_4h4B2hb
    if _struct_4h4B2hb is None:
        _struct_4h4B2hb = struct.Struct("<4h4B2hb")
    return _struct_4h4B2hb
_struct_3I = None
def _get_struct_3I():
    global _struct_3I
