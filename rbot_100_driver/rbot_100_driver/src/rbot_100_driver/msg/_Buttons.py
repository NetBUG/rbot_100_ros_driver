...
"""autogenerated by genpy from rbot_100_driver/Buttons.msg. Do not edit."""
import sys
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_8B().pack(_x.clean, _x.spot, _x.dock, _x.day, _x.hour, _x.minute, _x.schedule, _x.clock))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.clean, _x.spot, _x.dock, _x.day, _x.hour, _x.minute, _x.schedule, _x.clock,) = _get_struct_8B().unpack(str[start:end])
