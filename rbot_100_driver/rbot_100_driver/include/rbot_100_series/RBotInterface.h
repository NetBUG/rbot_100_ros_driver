...
byte RBOT_INITSTR[5] =  		{0xFE, 0x20, 0x01, 0x3F, 0x5E};
byte RBOT_INIT[4][4] =  	 	{{0xFE, 0x08, 0x00, 0x08}, 
       {0x00, 0x08, 0x00, 0x08}, 
//     #  [0x00, 0x16, 0x00, 0x16], 
       {0x01, 0x08, 0x00, 0x09},
       {0x02, 0x08, 0x00, 0x0A}}; 
byte RBOT_INIT2[5] =           {0x05, 0x27, 0x01, 0xF4, 0x21};
byte RBOT_INIT3[7] = 		{0x05, 0x72, 0x04, 0x7F,  0x7F,  0x7F,  0x7F, 0x77};
byte RBOT_BACK[8] = {00 0xD2 04 05 00 0xFB 0xFF 0xD5}; // looks like {go back"
byte RBOT_STOP[8] = {0x00, 0xD2, 0x04, 0x00, 0x00, 0x00, 0x00, 0xD6}; // looks like {stop};
byte RBOT_FWD[8] = {0x00, 0xD2, 0x04, 0xFB, 0xFF, 0x05, 0x00, 0xD5}; // looks like {go fwd};
byte RBOT_CCW[8] = {0x00, 0xD2, 0x04, 0xFB, 0xFF, 0xFB, 0xFF, 0xCA}; // looks like {left/counterclockwise};
byte RBOT_CW[8] = {0x00, 0xD2, 0x04, 0x05, 0x00, 0x05, 0x00, 0xE0}; // looks like {right/clockwise};
byte RBOT_HEAD_RIGHT[8] = {0x05, 0x7C, 0x03, 0x02, 0x00, 0x00, 0x86};    // looks like {head right}; movement
byte RBOT_HEAD_LEFT[8] = {0x05, 0x7C, 0x03, 0xFE, 0x00, 0x00, 0x82};    // looks like {head left}; movement
byte RBOT_HEAD_DOWN[8] = {0x05, 0x7C, 0x03, 0x00, 0x02, 0x00, 0x86};    // {head down};
